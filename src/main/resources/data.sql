...
INSERT INTO User (id, version, first_name, second_name, middle_name, address, phone, position, is_identified, office_id, citizenship_id)
 VALUES (1, 0, 'Иван', 'Иванов', 'Иванович', 'ул. Лесная, 20', '+79990003322', 'manager', 1, 1, 1);

INSERT INTO User (id, version, first_name, second_name, middle_name, address, phone, position, is_identified, office_id, citizenship_id)
 VALUES (2, 0, 'Иван', 'Петр', 'Петрович', 'ул. Лесная, 21', '+79990003323', 'manager', 1, 1, 1);

INSERT INTO User (id, version, first_name, second_name, middle_name, address, phone, position, is_identified, office_id, citizenship_id)
 VALUES (3, 0, 'Петров', 'Петр', 'Петрович', 'ул. Снежная, 55', '+79000123456', 'manager', 1, 2, 1);

INSERT INTO User (id, version, first_name, second_name, middle_name, address, phone, position, is_identified, office_id, citizenship_id)
 VALUES (4, 0, 'Петров', 'Иван', 'Иванович', 'ул. Снежная, 56', '+79000123411', 'manager', 1, 2, 1);
...
INSERT INTO User_doc (id, version, doc_id, doc_number, doc_date)
 VALUES (2, 0, 1, '8889 1234599', '2001-10-15');

INSERT INTO User_doc (id, version, doc_id, doc_number, doc_date)
 VALUES (3, 0, 1, '5556 654378', '1992-10-25');

INSERT INTO User_doc (id, version, doc_id, doc_number, doc_date)
 VALUES (4, 0, 1, '5555 654321', '1990-05-25');